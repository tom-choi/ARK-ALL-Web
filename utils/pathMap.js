...
export const BASE_URI = settings.is_local_test ? 'http://127.0.0.1:8000/api' : 'https://umall.one/api/';
// 用適配API返回的圖片相對路徑
export const BASE_HOST = settings.is_local_test ? 'http://127.0.0.1:8000' : 'https://umall.one';
